...
import { useDispatch, useSelector } from "react-redux";  // Import useSelector to access the current user
import {
  getStorage,
  ref,
  getDownloadURL,
...
const AddTask = ({ open, setOpen, task }) => {
  ...
  const [team, setTeam] = useState(task?.team || (user ? [user] : []));  // Pre-select the current user in the team state
